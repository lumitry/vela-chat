        ...
        if message_ids:
            ...
            for att in attachments:
                ...
                if msg_id_str:
                    ...
                    log.debug(f"normalized_to_legacy_format: Loaded attachment from DB: message_id={msg_id_str}, file_id={att.file_id}, url={att.url}, mime_type={att.mime_type}, type={att.type}")
